...
instance atran :: (bbi) near_quantale_Sup
  by default (transfer, auto)

instance atran :: (bbi) near_quantale_Sup_unital ..

instance atran :: (bbi) pre_quantale_Sup
  by (default, transfer, drule comp_add_mono) (simp add: mono_qSup_subdistl)

instance atran :: (bbi) quantale_Sup
apply default
apply transfer
apply (rule le_funI)
apply (simp add: comp_additive_def SUP_def) 
apply (rule Sup_least)
apply (rule Sup_upper)
apply simp
...
instance atran :: (bbi) quantale_Sup_unital ..
