...
instantiation "fun" :: (partial_semigroup, quantale_Sup) quantale_Sup
begin
...
instantiation "fun" :: (partial_monoid, quantale_Sup_unital) quantale_Sup_unital
begin
...
instance "fun" :: (partial_ab_semigroup, comm_quantale_Sup) comm_quantale_Sup
proof (default, simp_all add: mult_assoc, rule ext)
  fix f g :: "'a :: partial_ab_semigroup \<Rightarrow> 'b :: comm_quantale_Sup"
  ...
  also have "... = \<Squnion> {g z * f y | z y. x = z \<oplus> y \<and> z ## y}"
    ...
    by (metis mult_commute pmult_comm pmult_comm_def)+
  finally show "(f * g) x = (g * f) x" by simp
qed

instance "fun" :: (partial_comm_monoid, comm_quantale_Sup_unital) comm_quantale_Sup_unital 
  by default auto

text {* Distributivity is also lifted *}

instance "fun" :: (partial_semigroup, distrib_quantale_Sup) distrib_quantale_Sup .. 

instance "fun" :: (partial_comm_monoid, distrib_comm_quantale_Sup_unital) distrib_comm_quantale_Sup_unital ..
