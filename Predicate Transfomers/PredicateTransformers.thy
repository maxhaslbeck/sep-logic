...
instantiation "fun" :: (quantale_Sup, quantale_Sup) quantale_Sup
begin
...
instantiation "fun" :: (quantale_Sup_unital, quantale_Sup_unital) quantale_Sup_unital
begin
...
instance "fun" :: (comm_quantale_Sup_unital, comm_quantale_Sup_unital) comm_quantale_Sup_unital 
  by default auto

text {* Distributivity is also lifted *}

instance "fun" :: (distrib_quantale_Sup, distrib_quantale_Sup) distrib_quantale_Sup .. 

instance "fun" :: (distrib_comm_quantale_Sup_unital, distrib_comm_quantale_Sup_unital) distrib_comm_quantale_Sup_unital ..
